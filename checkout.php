<?php 
    ...
    //cart total
     ...
     foreach ($_SESSION['cart'] as $key=>$val){
       ...
       $house_number=get_safe_value($con, $_POST['house_number']);
       $address=get_safe_value($con, $_POST['address']);
       $city=get_safe_value($con, $_POST['city']);
       $pin=get_safe_value($con, $_POST['pin']);
       $payment_type=get_safe_value($con, $_POST['payment_type']);
       //getting user id from user_session
       ...
       orders (house_number, address, city, pin, payment_type, user_id, total_payment, order_status, added_on) VALUES 
       ('$house_number','$address','$city','$pin','$payment_type','$user_id','$total_payment','$order_status','$added_on')");
                        ...
                        <div class="checkout__inner">
                            <div class="accordion-list">
                                <div class="accordion">
                                    ...
                                    <?php
                                    // making of default accordian class
                                        ...
                                        <div class="bilinfo">
                                            <form action="#" method="post">
                                                <div class="row">
                                                     <div class="col-md-12">
                                                        <div class="single-input">
                                                            <input type="text" name="house_number" placeholder="Apartment/Block/House Number" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="single-input">
