    ...
    if(is_error==''){
        ...
        success:function(result){
           if(result =='email_present'){
            jQuery('#email_error').html('Email Already exits');
           }
           if(result =='insert'){
            jQuery('.register_msg p').html('Account Has been created.');
           }
        }
    });
    }
...
function user_login(){
   ...
   if(email==""){
    ...
    if(is_error==''){
        ...
        success:function(result){
           if(result =='wrong'){
            jQuery('.login_msg p').html('Please Enter Valid Email And Password');
           }
           if(result =='valid'){
